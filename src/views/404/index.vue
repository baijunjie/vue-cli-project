<template>
  <section class="http404-container">
    <div class="http404">
      <div class="pic-404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops">{{ T('name') }}</div>
        <div class="bullshit__headline">{{ T('messageTitle') }}</div>
        <div class="bullshit__info">{{ T('messageContent') }}</div>
        <router-link to="/" class="bullshit__return-home">{{ T('backToHome') }}</router-link>
      </div>
    </div>
  </section>
</template>
